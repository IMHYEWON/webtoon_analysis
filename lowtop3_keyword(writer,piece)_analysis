...
def writer_Word2vec(remove_writer_pos):
    model = Word2Vec.load('Word2vec.model.lowtop3')
...
file_path1 = "./devil_webtoon.csv"
file_path2 = "./hello_webtoon.csv"
file_path3 = "./snow_webtoon.csv"
file_stopwords_path = 'stopword5.csv'

df1= pd.read_csv(file_path1,engine='python')
df2= pd.read_csv(file_path2,engine='python')
df3= pd.read_csv(file_path3,engine='python')
...
df.to_csv("lowtop3_writer_keyword.csv",encoding="utf-8-sig",index=False)
...
print(data)
df = pd.DataFrame(data)
df.to_csv("lowtop3_piece_keyword.csv",encoding="utf-8-sig",index=False)
